...
const classNames = {
  ...
  badgeActive: 'ButtonItem__badge--active',
};
...
const ButtonItemList = ({
  ...
  const getMenuElement = useLastCallback(
    () => document.querySelector('#portals')!.querySelector('.ButtonItem-context-menu .bubble'),
  );
  const getLayout = useLastCallback(() => ({ withPortal: true }));

  return (
    <div
      className={buildClassName('ButtonItemList', onClick && 'ButtonItem--interactive', className)}
      onClick={handleClick}
      onMouseDown={handleMouseDown}
      onContextMenu={handleContextMenu}
      ref={tabRef}
    >
      <span className="ButtonItem_inner">
